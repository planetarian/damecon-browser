...
;(function () {
  ;(function (n) {
    ...
    ;(function (n) {
      ...
      a.a = (function () {
        ...
        return {
          ...
          Yb: function (b) {
            b = a.a.la(b)
            for (
              var c = ((b[0] && b[0].ownerDocument) || w).createElement('div'), d = 0, e = b.length;
              d < e;
              d++
            )
        ...
        a.a.ua = function (c, d) {
          ...
          if (v)
            ...
            'function' == typeof l.innerShiv
              ...
              : (g && e.body.appendChild(q), (q.innerHTML = t), g && q.parentNode.removeChild(q))
            for (; p--; ) q = q.lastChild
      ...
      a.Qc = function (a) {
        return (
          null != a && 'function' == typeof a.subscribe && 'function' == typeof a.notifySubscribers
        )
      }
          ...
          if (1 < d.length) {
            for (var x = 0, B; (B = d[x]); ++x) {
              ...
              if (44 === u) {
                if (0 >= h) {
                  c.push(
                    p && q.length ? { key: p, value: q.join('') } : { unknown: p || q.join('') },
                  )
                  p = h = 0
                  q = []
                  continue
                ...
                47 === u && x && 1 < B.length
                  ? (u = d[x - 1].match(f)) &&
                    !g[u[0]] &&
                    ((b = b.substr(b.indexOf(B) + 1)), (d = b.match(e)), (x = -1), (B = '/'))
                  : 40 === u || 123 === u || 91 === u
                    ? ++h
                    : 41 === u || 125 === u || 93 === u
                      ? --h
                      : p || q.length || (34 !== u && 39 !== u) || (B = B.slice(1, -1))
              q.push(B)
            }
          ...
          vb: function (e, f) {
            function l(b, e) {
              ...
              if (!x) {
                ...
                k &&
                  q.push(
                    "'" + ('string' == typeof h[b] ? h[b] : b) + "':function(_z){" + f + '=_z}',
                  )
              }
      ...
      ;(function () {
        ...
        a.fa = function (b, c, d, e, f) {
          ...
          f && f.exportDependencies
            ? k()
            : ((q = a.xb(k)), q.v(), q.ja() ? (q.equalityComparer = null) : (l[t] = n))
        }
        ...
        c.prototype.Cc = function () {
          ...
          this.yc.N &&
            !this.kb.length &&
            ((this.yc.N = null), a.a.K.yb(this.node, b), a.i.ma(this.node, a.i.pa), this.Tc())
        }
        a.i = {
          H: 'childrenComplete',
                ...
                function () {
                  ...
                  if (n || m !== l) {
                    ...
                    if (m) {
                      ...
                      r = d
                        ? k.createChildContext('function' == typeof h ? h : c, q)
                        : a.S.qa()
                          ? k.extend(null, q)
                          : k
                    }
        ...
        update: function (b, c, d) {
          ...
          k &&
            ...
            d.has('optionsCaption') &&
              ((k = a.a.f(d.get('optionsCaption'))), null !== k && k !== n && q.unshift(Q)))
          var x = !1
        ...
        a.c.textInput = {
          init: function (b, c, k) {
            ...
            function m() {
              ...
              L !== n && d === L
                ? a.a.setTimeout(m, 4)
                : b.value !== d && ((y = !0), (b.value = d), (y = !1), (v = b.value))
            }
            function r() {
        ...
        a.C.F.prototype.nodes = function () {
          ...
          if (0 == arguments.length) {
            ...
            if (!f || e.jd) {
              ...
              g &&
                g !== e.bb &&
                ((f = a.a.Md(g, b.ownerDocument)), a.a.g.set(b, c, { lb: f, bb: g, jd: !0 }))
            }
            return f
          }
          e = arguments[0]
      ...
      ;(function () {
            ...
            return a.$(
              function () {
                var g =
                    c && c instanceof a.fa
                      ? c
                      : new a.fa(c, null, null, null, { exportDependencies: !0 }),
                  n = f(b, g.$data, g),
                  g = e(m, t, n, g, h)
        ...
        a.Qd = function (b, d, g, h, m) {
          ...
          var v,
            z = g.as,
            w =
              !1 === g.includeDestroyed || (a.options.foreachHidesDestroyed && !g.includeDestroyed)
              ...
              switch (((H = G.moved), (K = G.index), G.status)) {
                case 'deleted':
                  ...
                  H === n &&
                    ...
                    y.$ && (y.$.s(), (y.$ = n)),
                    a.a.Ua(y.Y, e).length &&
                      (h.beforeRemove && (v.push(y), I++, y.Aa === d ? (y = null) : C.push(y)),
